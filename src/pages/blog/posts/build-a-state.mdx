...
When we ask ourselves for example why murder is wrong something like "people deserve a rite to safety" often comes up, but this answer begs the question. Why do we have the rites we do, and how did we even come up with them?

## The first pillar
When building the system that defines a state, it all starts with subjectivity. Each state will have a philosophy that stands on top of subjective decisions both implicit and explicit. In the secularized west this typically follows some formulation of people having individual worth, and some formulation of freedoms that follow from this. If instead we were in a religious monarchy the state foundation would be one of the divine rite of the king to act as he saw fit, and/or religious law. If we were in a statist society it would be that the needs of many outweigh the needs of the individual. No matter your position you start from, it is **always subjective**.
...
If the state is large enough you may need to create enclaves of state power such as provincial/state government organizations, municipal organizations and topic-oriented agencies (environmental protection, consumer rites etc.). 
